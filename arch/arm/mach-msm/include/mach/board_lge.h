...
#else
// LGE_CHANGE [jaekyung83.lee@lge.com] 2011-01-20, [Gelato] APDS9190 Sensor Device Add [START]
/* proximity apds9190 platform data */
struct proximity_platform_data {
	int irq_num;
	int (*power)(unsigned char onoff);
	int methods;
...
// LGE_CHANGE [jaekyung83.lee@lge.com] 2011-01-20, [Gelato] APDS9190 Sensor Device Add [END]
#endif
...
// LGE_CHANGE [jaekyung83.lee@lge.com] 2011-01-11, K3DH Sensor Device Add [START]
...
// LGE_CHANGE [jaekyung83.lee@lge.com] 2011-01-11, K3DH Sensor Device Add [END]
#else
...
// LGE_CHANGE_S [myeonggyu.son@lge.com] [2011.02.06] [gelato] add pwm gpio num [START]
	int pwm_gpio;
// LGE_CHANGE_E [myeonggyu.son@lge.com] [2011.02.06] [gelato] add pwm gpio num [END]
};
...
/* LGE_CHANGE [hoseok.kim@lge.com] 2011-01-04, support for AUO Panel */
struct msm_panel_auo_pdata {
	int gpio;
	int (*backlight_level)(int level, int max, int min);
	int (*pmic_backlight)(int level);
	int (*panel_num)(void);
